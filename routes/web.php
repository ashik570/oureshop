...
// {
//     return view('frontend/pages/product/newproduct');
// });

Route::get('/newproduct', 'Frontend\NewproductController@index');
...
// Route::any('/searchContent', function(){
// 	dd(Input::get('search'));
// });
//Category Route
...
Route::post('/update', 'Frontend\UsersController@profileUpdate')->name('user.profile.update');
...
Route::group(['prefix' => '/products'], function(){
		...
		Route::post('product/delete/{id}', 'Backend\ProductsController@delete')->name('admin.products.delete');
...
Route::group(['prefix' => '/sliders'], function(){
		...
		Route::post('district/edit/{id}', 'Backend\SlidersController@update')->name('admin.slider.update');

		Route::post('district/delete/{id}', 'Backend\SlidersController@delete')->name('admin.slider.delete');
