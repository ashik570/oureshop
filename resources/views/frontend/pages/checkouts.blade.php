	...
	<div class="card card-body mt-2">
		...
		<form method="POST" action="{{ route('checkouts.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea  id="message" rows="4" name="message" class="form-control @error('message') is-invalid @enderror"></textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea  id="shipping_address" rows="4" name="shipping_address" class="form-control @error('shipping_address') is-invalid @enderror">{{ Auth::check() ? Auth::user()->shipping_address : '' }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    @foreach($payments as $payment)
							...
							@if($payment->short_name == "cash_in")
								...
								@else
								<div id="payment_{{ $payment->short_name }}" class="text-center mt-2 hidden">
