...
<div class="container">
    <div class="card-body mb-5">
        <form method="POST" action="{{ route('user.profile.update') }}">
            ...
            <div class="form-group row">
                <label for="shipping_address" class="col-md-4 col-form-label text-md-right">{{ __('shipping_address (optinal)') }}</label>

                <div class="col-md-6">
                    <textarea  id="shipping_address" rows="4" name="shipping_address" class="form-control @error('shipping_address') is-invalid @enderror">{{ $user->shipping_address }}
                    </textarea>
